...
const QMetaObject SignUpWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_SignUpWindow.offsetsAndSize,
    qt_meta_data_SignUpWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SignUpWindow_t
